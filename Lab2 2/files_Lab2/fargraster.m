...
%Isak Greatrex isagr142 & Pedram AbPedab341
...
if strcmp(metod, "errordif")
    R = errordif(R, [0 0 7; 3 5 1]/16);
    G = errordif(G, [0 0 7; 3 5 1]/16);
    B = errordif(B, [0 0 7; 3 5 1]/16);
    ut = cat(3, R, G ,B);
    imshow(ut);
    disp ("errordif succes");
